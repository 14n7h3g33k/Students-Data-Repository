...
<body>
	...
	<nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="admin.php">Students Repository</a>
        </div>
    ...
    <br><br><br><br><br><br>
      ...
      <img src="Adminlogo.png" alt="Admin Students Repository" style="height: auto;width:auto;" " >
      </div>
      <br><br>   
      <section>
      <div class="col-md-10 col-md-offset-1"  style="background :" >
        ...
        <div class="container" >
          <div class="col-md-12">
              ...
              <form action="admin.php" method="POST" id="register-form"  >
              <div class="row">
                <div class="col-md-12">
                <div class="col-md-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM inf245 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM inf245 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM inf243 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM inf243 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM inf210 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM inf210 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                     <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM inf211 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM inf211 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM inf230 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM inf230 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM ins201 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM ins201 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM ins202 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM ins202 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                     <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM ins203 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM ins203 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                       <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM ins210 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM ins210 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM ins211 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM ins211 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                     <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM ins212 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM ins212 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM mes210 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM mes210 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                     <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM mes211 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM mes211 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                     <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM mes212 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM mes212 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                     <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM mes220 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM mes220 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                      <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM mes221 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM mes221 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
                                    ...
                                    <td><a href="uploads/<?php echo $row['file'] ?>" target="_blank">view file</a></td>
                                      <td>
                                        <?php
                                            ...
                                            if(isset($_GET['remove_id']))
                                            {
                                                $res=mysql_query("SELECT file FROM mes223 WHERE id=".$_GET['remove_id']);
                                                $row=mysql_fetch_array($res);
                                                mysql_query("DELETE FROM mes223 WHERE id=".$_GET['remove_id']);
                                                unlink("uploads/".$row['file']);
                                                header("Location: admin.php");
                                            }
                                        ?>
